...
### 耐久テスト (ロングランテスト)
長時間の連続稼働による影響を調べる
- 与える負荷 : 適当な負荷を30~60分程度
   - 平時のリクエスト数 or 想定最大の80%など...
- 見たい内容 : メモリリークなどがないか

### 耐障害性試験
APIなどがダウンした場合に適切なフォールバックがされるか・メモリやCPUなどに異常が生じないかを確認する

- 与える負荷 : 特定のAPIをダウンさせた状態、適当な負荷を5~10分程度
- 見たい内容 : メモリリークなどがないか,フォールバック内容が適切か


### スケーラビリティテスト

- スケールアップ・スケールアウトなど機能の確認や、その際の性能を確認する
